...
namespace csFactoryPattern
{
    internal class Program
    {
        ...
        {
            /*
             Create a new console app that utilizes factory pattern by taking a user’s input of how many tires are on a vehicle 
...
Call this functionality in the Main method.*/
            ...
            IVehicle car        = VehicleFactory.GetVehicle(4);
        }
    }
}
